<template>
	<div>
		<div class="not-found">
			<div>
				<span>4</span>
				<svg @click="goTo()"version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
			...
			<div>
				<span>Wrong path pal, a smiling performance cookie will guide your way back</span>
			</div>
...
<style type="text/css" scoped>
	...
	.not-found div:first-child span {
		font-weight: 800;
		color: #EF5350;
		text-align: center;
		font-size: 140px;
