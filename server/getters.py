...
# specification = { 'name': 'regression analysis', 
#     'parameters': [
#     { 'param': 'of', 'options': ['amount']},
#     { 'param': 'method', 'options': ['interval']},
#     { 'param': 'steps', 'options': ['1']},
#     { 'param': 'depending on', 'options': ['uid']},
#     { 'param': 'regression models', 'options': ['linear']},
# ]}
# specification = {'name':'bla'}
# ahoj = performance_profile_postprocess('/home/parallels/Desktop/BP/git-test-dir', '.perun/jobs/time-echo-[_]-[world]-2018-04-13-12-10-17.perf', specification, False)
# print(ahoj)

# ahoj['name'] = 'regression_analysis'
# ahoj['params'] = [{'sampling':'1, 8'},{'aha':'1'}]
# print(ahoj['name'])

# data = [{ 'name':'memory', 'params':  [ {'sampling':['1', '2']} ,'aha']   }   ]
# data = ['echo', 'ls', 'ee']

# os.chdir('/home/parallels/Desktop/BP/git-test-dir')
# commands.config_set('local', 'cmds', data)


# bla = {'value': [{'name': 'normalizer', 'parameters': [{'param':'jj','options':['1']},{'param':'kkk', 'options': []},{'param': 'wwww', 'options': ['nn', 'kk']}]}], 'name': 'postprocessors', 'type': 'saveJobMatrixSettings', 'path': 'home/parallels/Desktop/BP/git-test-dir', 'section': 'collectionSpecification'}
# print(set_job_matrix_settings('kk', bla))

# os.chdir('/home/parallels/Desktop/martina-complexity-playground')
# get_single_profile_info('9c65a4f83dc3398cc24391a2fcaceb1834b137f8', 'memory-run_sorts-2018-04-26-07-54-34.perf')
# profile_realpath = '.perun/jobs/memory-mct-[_]-[_]-2018-03-26-12-16-36.perf'
# perf_profile = profile.load_profile_from_file(profile_realpath, is_raw_profile=True)
# dataframe = convert.resources_to_pandas_dataframe(perf_profile)
# ahoj = dataframe.to_dict(orient='records')
# print(ahoj);
# print(ahoj)
# print(dataframe.groupby(['amount', 'cluster'])['cluster'].mean())

# 


# os.chdir('/home/parallels/Desktop/degradation-playground')
# print(get_profiles_numbers('/home/parallels/Desktop/degradation-playground', 'git'))

        
# path = '/home/parallels/Desktop/BP/git-test-dir'

# bla = [
#     {'commit': 'b6632b4a17b0c95fcba7866067b3d94a956f11bd', 'name': 'time-echo-[_]-[hello]-2018-04-24-11-42-14.perf'},
#     {'commit': 'b6632b4a17b0c95fcba7866067b3d94a956f11bd', 'name': 'time-echo-[_]-[world]-2018-04-23-21-16-05.perf'}
# ]
# get_profiles_to_compare(path, bla[0], bla[1])
# get_performance_profiles_list('/home/parallels/Desktop/BP/git-test-dir', 'git', 'time-echo-[_]-[hello]-2018-04-24-11-42-14.perf')
